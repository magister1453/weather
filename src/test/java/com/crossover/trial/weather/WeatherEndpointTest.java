...
import com.crossover.trial.weather.adapter.rest.WeatherCollectorEndpointImpl;
import com.crossover.trial.weather.adapter.rest.WeatherQueryEndpointImpl;
import com.crossover.trial.weather.adapter.rest.WeatherCollectorEndpoint;
import com.crossover.trial.weather.adapter.rest.WeatherQueryEndpoint;
...
public class WeatherEndpointTest {
    ...
    public void setUp() throws Exception {
        _update.addAirport("BOS", "0.00", "0.00");
    ...
    public void testGet() throws Exception {
        List weather =  (List)_query.weather("BOS", "0").getEntity();
        AtmosphericInformation atmosphericInformation = (AtmosphericInformation)weather.get(0);
        assertEquals(atmosphericInformation.get(DataPointType.WIND), _dp);
    }
